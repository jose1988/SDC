...
<body class="appBg">
 ...
 <form id="formulario" method="post">      
       ...
       <table class='footable table table-striped table-bordered'>
             ...
             <tr>			 
			 	<td style="text-align:center">C.I o RIF</td>
				<td style="text-align:center"><input type="text" name="cedularif" id="cedularif" maxlength="19" size="30" title="Ingrese la cédula o el Rif" placeholder="Ej. 5126370"  ></td>
		     </tr>			 
			 ...
			 <tr>			 
				...
				<td style="text-align:center"><textarea style="width:500px;" id="direccion" name="direccion" style="width:800px" ></textarea></td>
		     </tr>
             <tr>
